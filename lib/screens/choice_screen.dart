...
import 'package:driver/screens/service_screen.dart';
...
class ChoiceScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const DefaultTextStyle(style: TextStyle(color:  Colors.white, fontSize: 30, fontStyle: FontStyle.normal), child: Text("What do you want?")),
