import 'package:driver/models/trip_model.dart';
import 'package:driver/providers/map_provider.dart';
import 'package:driver/services/database_service.dart';
            ...
            children: [
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    _buildInfoText('To: ', trip.destinationAddress != null ? trip.destinationAddress : ""),
                    const SizedBox(height: 2),
                    _buildInfoText(
                      'Distance: ',
              ...
              Chip(
                label: Text(
                  'Cost: \$${trip.cost != null ? trip.cost!.toStringAsFixed(2) : ""}',
